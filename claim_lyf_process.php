...
$pname=mysqli_fetch_assoc(mysqli_query($con, "SELECT POLICY_NAME FROM POLICY_LYF WHERE POLICY_ID='$policy'"))['POLICY_NAME'];
...
mysqli_query($con, "INSERT INTO claim_policy_id_lyf(claim_tr_id,policy_id_lyf,customer_id,policy_name) VALUES('$claim_transac','$policy','$id','$pname')");
mysqli_query($con, "DELETE FROM lyf_insurance WHERE CUSTOMER_ID=$id AND POLICY_ID='$policy'");
}
else
{
