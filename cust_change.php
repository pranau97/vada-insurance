...
mysql_query("UPDATE customer SET FIRST_NAME='$newname', LAST_NAME='$newlast', HOUSE_NUMBER='$newhouse', STREET='$newstreet', PHONE_NUMBER=$newphone, SEX='$newsex', EMAIL_ID='$newemail', DOB='$newdob', PASSWORD='$newpassword' 
WHERE CUSTOMER_ID='$id' ");
//mysql_query("INSERT INTO pin_state(pincode,state) VALUES('$newpincode','$newstate')");
//mysql_query("INSERT INTO pin_city(pincode,city) VALUES('$newpincode','$newcity')");
//mysql_query("UPDATE nominee SET NAME='$newnomi_name', LAST_NAME='$newlast', PHONE_NUMBER=$newnphone, SEX='$newnsex', RELATION='$newnrelation'
//WHERE CUSTOMER_ID='$id' ");
//mysql_query("UPDATE customer_account SET ACCOUNT_NUMBER='$newaccountnum' WHERE CUSTOMER_ID='$id' ");
