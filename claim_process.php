...
$pname=mysql_fetch_assoc(mysql_query("SELECT POLICY_NAME FROM POLICY WHERE POLICY_ID='$policy'"))['POLICY_NAME'];
...
mysql_query("INSERT INTO claim_policy_id(claim_tr_id,policy_id,customer_id,policy_name) VALUES('$claim_transac','$policy','$id','$pname')");
mysql_query("DELETE FROM aut_insurance WHERE CUSTOMER_ID=$id AND POLICY_ID='$policy'");
mysql_query("DELETE FROM prop_insurance WHERE CUSTOMER_ID=$id AND POLICY_ID='$policy'");
}
else
{
