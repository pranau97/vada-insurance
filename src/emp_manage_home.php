...
<div class="container">
      ...
      <form class="form-signin" method="post" action="emp_manage_login.php">
        <h2 class="form-signin-heading">Please sign in</h2>
        <label for="eid" class="sr-only">Employee ID</label>
		<input type="text" id="eid" class="form-control" placeholder="Email address" required autofocus name="eid">
		<br>
