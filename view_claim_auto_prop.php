...
$query3 = mysql_fetch_assoc(mysql_query("SELECT CLAIM_TR_ID FROM CLAIM_POLICY_ID WHERE POLICY_ID='$a' AND POLICY_NAME='$pname1' AND CUSTOMER_ID=$temp_cid"))['CLAIM_TR_ID'];
